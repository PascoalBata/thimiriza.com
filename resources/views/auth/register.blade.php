                ...
                <div class="col s12 m12 l12">
                    <form method="POST" action="{{ route('register') }}" onsubmit="return submeter()">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6 l6">
                                <input id="phone" type="number" class="black-text validate" data-length="255" name="phone" value="{{ old('phone') }}" required>
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6 l6">
                                <input type="number" class="black-text" id="nuit" name="nuit"
