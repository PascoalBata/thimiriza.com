        ...
        <form method="POST" action="{{ route('store_user') }}">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    ...
                    <button type="button" class="waves-effect waves-light btn-small" onclick="displayUserTable()">
                        {{ __('Utilizadores') }}
                        <i class="material-icons right"></i>
                    </button>
                </div>
        ...
        <table class="highlight">
            ...
            <tr>
                ...
                <td style="text-align: right;">
                    ...
                    <a class="modal-trigger waves-effect waves-light btn-small red darken-3" href="#remove_user_modal"
...
<script>
    ...
    function displayUserTable() {
        if (document.getElementById('user_table').style.display === 'none') {
...
<div class="alert alert-success">
    <script>
        M.toast({html: '{{ session('user_notification') }}', classes: 'rounded', displayLength: 1000});
    </script>
</div>
@endif
@endsection
