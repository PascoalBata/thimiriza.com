...
<div id="update_modal" tabindex="-1" class="modal modal-fixed-footer">
    <form method="POST" id="updateCompanyForm" name="updateCompanyForm" action="{{ route('edit_company') }}" enctype="multipart/form-data">
        <div class="modal-content">
            <h4>{{ __('Actualizacao de dados')}}</h4>
            @method('PUT')
            @csrf
            <input id="id" hidden type="text" class="black-text" name="id"
                           value="{{$company->id}}" required>
            <div class="row">
                <div class="input-field col s12 m6 l6">
                    <label for="name" class="black-text">{{ __('Nome') }}</label>
                    <input id="name" type="text" class="black-text" name="name"
            ...
            <div class="row">
                <div class="input-field col s12 m6 l6">
                    ...
                    <input id="email" type="email" class="black-text" name="email"
                    value="{{$company->email}}" required>
                </div>
                <div class="input-field col s12 m6 l6">
                    <label for="phone" class="black-text">{{ __('Telefone') }}</label>
                    <input id="phone" type="number" class="black-text" name="phone"
            ...
            <div class="row">
                <div class="input-field col s12 m6 l6">
                    ...
                    <input id="nuit" type="number" class="black-text" name="nuit"
                            value="{{$company->nuit}}" required>
                </div>
                <div class="input-field col s12 m6 l6">
                    <label for="address" class="black-text">{{ __('Endereco') }}</label>
                    <input id="address" type="text" class="black-text" name="address"
