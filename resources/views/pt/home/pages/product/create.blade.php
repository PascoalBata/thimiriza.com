    ...
    <form method="POST" action="{{ route('store_product') }}">
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <button style="margin-right: 0.5%; margin-top: 0.5%; min-width: 110px;" type="submit" class="waves-effect waves-light btn-small">
                    {{ __('Salvar') }}
                    <i class="material-icons right">archive</i>
                </button>
                <button style="margin-right: 0.5%; margin-top: 0.5%; min-width: 110px;" type="reset" class="waves-effect waves-light btn-small">
                    {{ __('Limpar') }}
